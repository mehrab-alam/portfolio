  ...
  return (
    <>
      ...
      >
        ...
        <h1 className='w-full py-2 text-center md:text-5xl'>
          Recent From Blog
        </h1>
        {morePost?.length > 2 && (
            ...
            {morePost?.map((blog, i) => {
              return (
                <div
                  ...
                  key={i}
                  className='h-full rounded  shadow-xl'
                >
                  <img
                    src={blog.coverImage}
                    alt=''
                  ...
                  <div className='py-8'>
                    ...
                    <h2 className='hover:text-primary-400 px-8 py-2 text-2xl  font-[600] text-white transition-all  hover:underline'>
                      <a className='text-inherit' href={`/blog/${blog.slug}`}>
                        {blog.title}
                      </a>
                    </h2>
